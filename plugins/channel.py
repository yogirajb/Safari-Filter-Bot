...
def clean_movie_title(filename):
    ...
    - Removes Channel Usernames, Branding & Tags (@Raje Movies, @MZ_Botz etc.)
    ...
    # 5. Universal Season & Episode Detection
    ...
    # 6. Quality, Codec, Audio & Tech boundaries
    ...
    # 7. Hard cut strictly at the earliest boundary
    first_cut = min(cut_positions)
    main_title = name[:first_cut]

    # 8. Clean punctuation & special symbols
