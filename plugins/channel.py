...
def clean_movie_title(filename):
    ...
    Accurately cuts off at Season, Episode, Year or Quality tokens.
    Handles Daily Serials (Episode 661), Web Series (S01E329) & Movies.
    """
    # 1. Remove extension
    ...
    # 4. Universal Season & Episode Cut Positions
    ...
    # 6. Hard cut strictly at the earliest boundary
