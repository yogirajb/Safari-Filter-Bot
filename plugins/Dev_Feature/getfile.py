...
async def getfile(client, message):
    try:
        ...
        # Yahan link ko sahi string format me kar diya gaya hai aur tags properly close hain
        formatted_text = (
            ...
            f"📕 Story: {hindi_plot}\n\n"
            f"🔗 <a href='{custom_link}'>Click Here Get Files</a>\n\n"
            f"⚡️ <b>Powered By : </b><a href='https://t.me/MzMoviiez'>MzMoviiez</a>"
        )
...
async def post_to_channels(client, callback_query):
    ...
    if action == "yes":
        ...
        # Callback query me bhi exact same text structure fixes ke sath update kar diya hai
        formatted_text = (
            f"<b>🔖Title: {movie_title}</b>\n"
            f"<b>🎬 Genres: {genres}</b>\n"
            f"<b>⭐️ Rating: {rating}/10</b>\n"
