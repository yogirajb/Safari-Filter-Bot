...
POST_CHANNELS = list(map(int, (channel.strip() for channel in environ.get('POST_CHANNELS', '-1001952500080').split(','))))
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://yogirajmr33:yogiraj2614@cluster0.4vr7f.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
