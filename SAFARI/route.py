...
async def stream_handler(request: web.Request):
    try:
        ...
        # render_page handles template rendering with proper headers
        page_html = await render_page(id, secure_hash)
...
async def media_streamer(request: web.Request, id: int, secure_hash: str):
    ...
    mime_type = file_id.mime_type or mimetypes.guess_type(file_name)[0]

    # MKV & Video MIME-Type fix for smooth streaming in VLC & Browsers
    ...
    # Use 'inline' to allow video streaming inside media players & browser players
    disposition = "inline"
